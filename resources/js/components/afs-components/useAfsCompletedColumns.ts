...
export function useAfsCompletedColumns(params: UseAfsCompletedColumnsParams) {
    ...
    return computed<ColumnDef<UnifiedItem>[]>(() => [
        ...
        { id: 'total_current_assets', header: 'Total Current Assets', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['total_current_assets', 'total current assets', 'total_assets', 'total assets']) },
        { id: 'inventory', header: 'Inventory', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['inventory']) },
        { id: 'gross_profit', header: 'Gross Profit', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['gross_profit', 'gross profit']) },
        { id: 'cogs', header: 'COGS', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['cogs', 'cost_of_goods_sold', 'cost of goods sold']) },
        { id: 'net_income', header: 'Net Income', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['net_income', 'net income']) },
        { id: 'cash', header: 'Cash', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['cash', 'cash_on_hand', 'cash on hand']) },
        { id: 'pt_payable', header: 'PT Payable', enableSorting: false, cell: ({ row }) => fieldValue(row.original, ['pt_payable', 'pt payable', 'payables', 'accounts_payable', 'accounts payable']) },
