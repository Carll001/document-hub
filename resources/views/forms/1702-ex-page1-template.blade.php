...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>1702-EX Page 1 Template Alignment</title>
        <style>
            :root {
                color-scheme: light;
                --bg: #edf2f7;
        ...
        <div class="alignment-shell">
            <section class="alignment-card">
                <div class="alignment-header">
                    <div>
                        <p class="alignment-kicker">1702-EX Page 1</p>
                        <h1 class="alignment-title">Page 1 Template Alignment</h1>
                        <p class="alignment-copy">
                            Adjust
                            <code>resources/forms/templates/1702-ex/page1.schema.json</code>,
                            compare the overlay against the page-1 template, and generate the
                            current page-1 PDF from the main mock payload.
                        </p>
                    </div>
            ...
            <div class="alignment-grid">
                <section class="alignment-card alignment-main">
                    ...
                    <p class="alignment-section-copy">
                        The page-1 template is shown below with the current schema overlay so you
                        can keep adjusting coordinates in
                        <code>page1.schema.json</code>.
                    </p>

                    @include('forms.partials.1702-ex-page1-blade-art', [
