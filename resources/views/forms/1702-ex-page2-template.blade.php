...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>1702-EX Page 2 Template Alignment</title>
        <style>
            :root {
                color-scheme: light;
                --bg: #edf2f7;
        ...
        <div class="alignment-shell">
            <section class="alignment-card">
                <div class="alignment-header">
                    <div>
                        <p class="alignment-kicker">1702-EX Page 2</p>
                        <h1 class="alignment-title">Page 2 Template Alignment</h1>
                        <p class="alignment-copy">
                            Adjust
                            <code>resources/forms/templates/1702-ex/page2.schema.json</code>,
                            compare the overlay against the page-2 template, and generate the
                            current page-2 PDF from the dedicated mock payload.
                        </p>
                    </div>
            ...
            <div class="alignment-grid">
                <section class="alignment-card alignment-main">
                    ...
                    <p class="alignment-section-copy">
                        The page-2 template is shown below with the current schema overlay so you
                        can keep adjusting coordinates in
                        <code>page2.schema.json</code>.
                    </p>

                    @include('forms.partials.1702-ex-page2-blade-art', [
                    ...
                    <section class="alignment-card alignment-sidebar-card">
                        ...
                        <div class="alignment-note-list">
                            <div class="alignment-note">
                                ...
                                <span><code>resources/forms/templates/1702-ex/page2.schema.json</code></span>
                            </div>
                            <div class="alignment-note">
                                <strong>Sample payload</strong>
                                <span><code>resources/forms/templates/1702-ex/page2-mock-payload.json</code></span>
                            </div>
                            <div class="alignment-note">
                                <strong>Background image</strong>
                                <span><code>public/form-assets/1702-ex/page2-template.png</code></span>
                            </div>
                            <div class="alignment-note">
                                <strong>Template PDF</strong>
                                <span><code>public/form-assets/1702-ex/template-page2.pdf</code></span>
                            </div>
                            <div class="alignment-note">
